...
<head>
    ...
    <title>The Road Ahead<?= $post_id = $_GET['id']?></title>
...
<body>  
    <header class="header">
        <div class="header__container">
            <div class="header__button">
                <a class="header__escape" href="/home">Escape.</a>
            </div>
            <nav class="header__navigation">
                <ul class="header__navigation__list">
                    <li class="navigation-item"><a class="header__navigation-link" href="/home">HOME</a></li>
    ...
    <main class="main">
        <div class="title">
            <h1><?= $post[$post_id - 1]['title'] ?></h1>
            <div class="subtitle"><?= $post[$post_id - 1]['subtitle'] ?></div>
        </div>
        <img class="<?= $post[$post_id - 1]['class']?>" src="<?= $post[$post_id - 1]['img']?>">
        <div class="text-block"><?= $post[$post_id - 1]['text']?></div>
    </main>
    <footer class="footer">
        <div class="footer__container">
            <div class="footer__button">
                <a class="footer__escape" href="/home">Escape.</a>
            </div>
            <nav class="footer__navigation">
                <ul class="footer__navigation__list">
                    <li class="navigation-item"><a class="footer__navigation-link" href="/home">HOME</a></li>
